...
router.post(
  ...
  (req, res) => {
    ...
    const values = [
      ...
      customer_requirements,
      feedback,
      files.pan ? files.pan[0].filename : null,
      files.tan ? files.tan[0].filename : null,
      files.aadhaar ? files.aadhaar[0].filename : null,
      files.telephone ? files.telephone[0].filename : null,
      files.bankCheque ? files.bankCheque[0].filename : null,
      files.creditForm ? files.creditForm[0].filename : null,
      files.incorporation ? files.incorporation[0].filename : null,
      files.gstForm ? files.gstForm[0].filename : null,
    ];
