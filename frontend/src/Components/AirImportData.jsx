...
function AirImportData() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Failed to save air import data");
    }
  };
  ...
  return (
    <div className="ml-12 p-4">
      <form
        ...
        className="grid grid-cols-1 gap-4 lg:gap-20 lg:grid-cols-3 md:grid-cols-2"
      >
        {/* Left Column */}
        <div className="first">
          {/* Job Details */}
        ...
        <div>
          ...
          <div>
            <div className="field-center my-3 grid lg:grid-cols-2 gap-4">
              ...
              <input
                type="date"
                name="shipper_invoice_date"
                value={formData.shipper_invoice_date}
                onChange={handleChange}
                className="label-input w-full border px-3 border-slate-800 rounded"
              />
            </div>
            ...
            <div className="field-center grid lg:grid-cols-2 gap-4 mt-4">
              ...
              <input
                type="text"
                name="shipper_currency"
                value={formData.shipper_currency}
                onChange={handleChange}
                className="label-input w-full border px-3 border-slate-800 rounded"
              />
            </div>
