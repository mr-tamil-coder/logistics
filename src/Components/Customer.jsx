                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative', display: 'inline-block'}}>
                                <input type="text" />
                                <FaSave style={{ position: 'absolute', top: '50%', right: '10px', transform: 'translateY(-50%)', pointerEvents: 'none' }}/>
                            </div>
                            <br/>
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative', display: 'inline-block'}}>
                                 <input type="text"/>
                                 <FaSave style={{ position: 'absolute', top: '50%', right: '10px', transform: 'translateY(-50%)', pointerEvents: 'none' }}/><br/>
                            </div></div>
                        </div>
